...
from .views import UserLogin, UserRegistration, EmailConfirmation, PasswordChange, PasswordReset, UserUpdateView, UserListView, UserDetailView, PasswordResetVerify, UserProfileDetailView 
